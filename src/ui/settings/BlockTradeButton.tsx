...
export default function BlockTradeButton({ enabledSelector, setEnabledSelector, label, colors, tooltip }: Props) {
  ...
  return (
    <Tooltip text={tooltip}>
      <label
        className={`w-fit min-w-0 ${colors.bgColor} my-2 flex cursor-pointer items-center gap-2 rounded-md border p-1
          px-2 select-none`}
      >
